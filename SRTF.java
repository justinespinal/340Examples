...
public class SRTF {
    ...
    public SRTF(ArrayList<HashMap<String, Integer>> processes){
...
class RemainingTimeComparator implements Comparator<HashMap<String, Integer>> {
    @Override
    public int compare(HashMap<String, Integer> map1, HashMap<String, Integer> map2) {
        if(Integer.compare(map1.get("BT"), map2.get("BT")) != 0)
            return Integer.compare(map1.get("BT"), map2.get("BT"));
        else
